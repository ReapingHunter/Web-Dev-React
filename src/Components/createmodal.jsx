        ...
        <div className="modal" tabIndex="-1" role="dialog" id ="createcontactmodal">
            ...
            <div className="modal-content">
                ...
                <div className="alert alert-danger" id="alertdanger" role="alert">
                    ...
                    <input type="text" name="fname" placeholder="John" id="firstname" className="form-control" onChange={firstName} value={fname} required></input><br />
                    <label htmlFor="exampleFormControlInput1">Enter Last Name:</label>
                    <input type="text" name="lname" placeholder="Doe" id="lastname" className="form-control" onChange={lastName} value={lname} required></input><br />
                    <label htmlFor="exampleFormControlInput1">Enter Email Address:</label>
                    <input type="email" name="emailAdd" placeholder="johndoe@xyz.com" id="email" className="form-control" onChange={emailAddress} value={emailAdd} required></input><br />
                    <label htmlFor="exampleFormControlInput1">Enter Contact Number:</label> <br />
                    <input type="number" name="contactNum" placeholder="09999999999" id="contact" onChange={contactNumber} value={contactNum} required></input><br />
                </div>
